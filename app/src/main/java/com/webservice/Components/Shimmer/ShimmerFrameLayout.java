...
package com.webservice.Components.Shimmer;
  ...
  public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        if (a.hasValue(R.styleable.ShimmerFrameLayout_angleshimmer)) {
          int angle = a.getInt(R.styleable.ShimmerFrameLayout_angleshimmer, 0);
          switch (angle) {
            default:
            case 0:
